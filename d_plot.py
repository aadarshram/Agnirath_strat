    ...
    app.layout = html.Div([
        ...
        html.Div([
            ...
            dcc.Graph(
                ...
                figure={
                    'data': [
                        ...
                        go.Scatter(x=[min(distances), max(distances)], y=[d_config.MAX_V, d_config.MAX_V], mode='lines', name="Max Velocity", line=dict(color='red', dash='dot')),
                        ...
                        go.Scatter(x=[max(distances), max(distances)], y=[0, d_config.MAX_V], mode='lines', name="ControlStop", line=dict(color='blue', dash='dot')),
                    ],
            ...
            html.Div([
                ...
                html.P(f"Time Taken: {time[-1]//3600-3}hrs {(time[-1]%3600)//60-7}mins {round(((time[-1]%3600)%60), 3)}secs"),
            ...
            dcc.Graph(
                ...
                figure={
                    'data': [
                        ...
                        go.Scatter(x=[min(distances), max(distances)], y=[d_config.DISCHARGE_CAP*100, d_config.DISCHARGE_CAP*100], mode='lines', name="Minimum battery Level", line=dict(color='orange', dash='dot')),
