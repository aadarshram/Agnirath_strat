...
for i in range(RunforDays):
    ...
    InitialBatteryCapacity, timeoffset, FinalBatteryCapacity = set_day(present_battery_cent, i, time_counter)

    outdf, timetaken = main(route_df, cum_d, i, InitialBatteryCapacity, timeoffset, FinalBatteryCapacity) # Set day wise params
